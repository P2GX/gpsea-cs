...
\hline
\end{tabular}
\caption{\textbf{Phenotype severity scores.} Mann-Whitney U tests performed using GPSEA to assess the association between a genotype and the total value of a phenotype severity score.
...
{lllllllllll}
\caption{
  \textbf{Detailed results for Table 1 of the main manuscript.}
...
\input{generated/v9_6/proportions}
