...
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption{Onset of stage 5 chronic kidney disease for \textit{CLDN16} missense vs. other variants. This result is similar to that of Konrad et al. (2008) \cite{PMID_18003771}.}
\end{subfigure}
...
\caption{ The cohort comprised 51 individuals (21 females, 29 males, 1 with unknown sex). A total of 53 HPO terms were used to annotate the cohort. Disease diagnosis: Hypomagnesemia 3, renal (OMIM:248250). A total of 23 unique variant alleles were found in \textit{CLDN16} (transcript: \texttt{NM\_006580.4}, protein id: \texttt{NP\_006571.2}).}
\end{figure}
