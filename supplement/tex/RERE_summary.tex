...
\midrule
Assign a phenotype score that is equivalent to the count of present phenotypes that are either an exact match to the query terms or their descendants & HPO group count & LoF & Atrophin & 0.001 & -\\
\bottomrule
\end{tabular}
}
\caption{ HPO Group Count to compare LoF and Atrophin with respect to HPO group count. }
\end{subfigure}
