...
\caption{Distribution of variants in \textit{POGZ}}
\end{subfigure}
...
\midrule
A phenotypic severity score according to Nagy et al. 2022 & \textit{POGZ} Severity Score & Missense & Other & 0.429 & -\\
\bottomrule
\end{tabular}
}
\caption{ POGZ Severity Score to compare Missense and Other with respect to \textit{POGZ} Severity Score. }
\end{subfigure}
