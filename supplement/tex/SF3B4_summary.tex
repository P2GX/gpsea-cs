...
\caption{Distribution of variants in \textit{SF3B4}}
\end{subfigure}
...
In one published analysis, it was stated that ``although no significant genotype–phenotype association was found, it is notable that patients with frameshift \textit{SF3B4} variants and predicted to lead to nonsense-mediated RNA 
