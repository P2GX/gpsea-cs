...
\midrule
AKKRD11 phenotype score & HPO group count & SV & other & $2.64\times 10^{-4}$ & \cite{PMID_36446582}\\
\bottomrule
\end{tabular}
}
\caption{AKKRD11 phenotype score for structural variants: 4.62; other variants: 5.94.}
\end{subfigure}
