\begin{figure}[htbp]
        ...
        \midrule
        Peripheral axonal neuropathy [HP:0003477] & 3/3 (100\%) & 1/22 (5\%) & 0.002 & 0.033\\
        \bottomrule
        \end{tabular}
        }
        \captionsetup{justification=raggedright,singlelinecheck=false}
        ...
        Arg50Gln/Arg50Gln OR Arg50Gln/other & other/other & 21 & 0\\
        FEMALE & MALE & 24 & 0\\
        \bottomrule
        \end{tabular}
        }
        ...
        \midrule
        Compute time until postnatal death & Age of death & Pro98Leu/Pro98Leu & other/other OR Pro98Leu/other & 0.010 & -\\
        \bottomrule
        \end{tabular}
        }
        ...
        Description & Variable & Genotype (A) & Genotype (B) & p-value & xrefs\\
        \midrule
        Compute time until OMIM:256810 onset & Onset of OMIM:256810 & missense/missense OR missense/other & other/other & 0.002 & -\\
        \bottomrule
        \end{tabular}
        }
