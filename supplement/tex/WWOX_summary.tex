...
\caption{Distribution of variants in \textit{WWOX}}
\end{subfigure}
...
Phenotype/genotype correlations were recently suggested for \textit{WWOX}-related neurodevelopmental disorders 
with a classification of \textit{WWOX} genotypes into three groups. According to the tentative classification, patients carrying two predicted null alleles were more likely to present with the most severe WOREE phenotype whereas hypomorphic genotypes 
