...
\caption{Distribution of variants in \textit{SUOX}}
\end{subfigure}
\begin{subfigure}[b]{0.45\textwidth}
\centering
\includegraphics[width=\textwidth]{ img/SUOX_stats.pdf} 
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption{Survival analysis: \textit{SUOX} missense variants and disease onset}
\end{subfigure}
...
\midrule
Missense/Missense OR Missense/Other & Other/Other & 15 & 0\\
Moco domain/Moco domain OR Moco domain/Other & Other/Other & 15 & 0\\
\bottomrule
\end{tabular}
}
\captionsetup{justification=raggedright,singlelinecheck=false}
