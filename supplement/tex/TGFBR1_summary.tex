...
\midrule
Self-healing squamous epithelioma [HP:0034720] & 18/19 (95\%) & 0/21 (0\%) & $1.68\times 10^{-10}$ & $2.68\times 10^{-9}$\\
Hypertelorism [HP:0000316] & 0/18 (0\%) & 15/19 (79\%) & $5.01\times 10^{-7}$ & $4.01\times 10^{-6}$\\
Arterial tortuosity [HP:0005116] & 1/19 (5\%) & 8/16 (50\%) & 0.005 & 0.026\\
\bottomrule
\end{tabular}
}
\captionsetup{justification=raggedright,singlelinecheck=false}
...
\midrule
Self-healing squamous epithelioma [HP:0034720] & 7/7 (100\%) & 11/33 (33\%) & 0.002 & 0.012\\
\bottomrule
\end{tabular}
}
\captionsetup{justification=raggedright,singlelinecheck=false}
\caption{Fisher Exact Test performed to compare HPO annotation frequency with respect to Gly52Arg and Other. Total of 7 tests were performed.}
\end{subfigure}
\vspace{2em}
\begin{subfigure}[b]{0.95\textwidth}
\centering
...
indicates a clear genotype-phenotype correlation between loss-of-function \textit{TGFBR1} mutations and MSSE \cite{PMID_21358634}.
}
\end{figure}
