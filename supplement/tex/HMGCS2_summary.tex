...
\begin{subfigure}[b]{0.35\textwidth}
    ...
    \captionsetup{justification=raggedright,singlelinecheck=false}
    \caption{Onset of \textit{HMGCS2} for missense/missense and missense/other vs. other/other variants.}
    \end{subfigure}
